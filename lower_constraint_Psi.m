...
% производную таким образом, чтобы выполн€лось ограничение Psi(y) > constr1

% F имеет следующую структуру
% массив y - массив функции Psi - массив dPsi / dy

% params и coefs нужны дл€ того, чтобы затем однозначно восстановить кривую
